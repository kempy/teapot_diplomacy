...
teapot.init = function() {
  ...
  instructionsScreen.params.text = (
      ...
      "All of our inputs will be in binary: 1's and 0's. And we will use the following operators: NOT, AND, OR, NOR, NAND, XOR, XNOR. All the operators will be clickable and you can place them into the gates.\n\n" +
      "Please look at this page for reference on what the operators all do and keep it open! http://en.wikipedia.org/wiki/Logic_gate#Symbols\n\n" +
...
interstitialLevel4_5.params.nextLevel = 'level5';
...
interstitialLevel5_6.params.nextLevel = 'level6';
...
interstitialLevel6_7.params.nextLevel = 'level7';
...
interstitialLevel7_8.params.nextLevel = 'level8';
...
interstitialLevel8_9.params.nextLevel = 'finish';
  ...
  lm.createLevel('level5', createLevelFiveFn('interstitialLevel5_6'));
  lm.createLevel('level6', createLevelSixFn('interstitialLevel6_7'));
  lm.createLevel('level7', createLevelSevenFn('interstitialLevel7_8'));
  lm.createLevel('level8', createLevelEightFn('interstitialLevel8_9'));
